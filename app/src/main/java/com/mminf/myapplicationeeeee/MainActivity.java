...
mViewPager.setCurrentItem(Integer.parseInt(date.toString()));
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            TextView cibo_giorno = (TextView)  rootView.findViewById(R.id.giorno);
        ...
        String[] giorno = menu_cibo[a].split(";");
            ...
            cibo_data.setText(giorno[0]); // DATA
            cibo_giorno.setText(giorno[1]); //GIORNO
            cibo_primo.setText("Primo: "+giorno[2]); //Primo
            cibo_secondo.setText("Secondo: "+giorno[3]); //secondo
            cibo_contorno.setText("Contorno: "+giorno[3]); //contorno
            cibo_dolce.setText("Frutta: "+giorno[3]); //dolce
